...
const items = [
    { name: 'info', icon: 'k-i-information', route: '/' },
    { name: 'overview', icon: 'k-i-globe', route: '/overview' },
...
// localizationService.toLanguageString(`custom.${selected}`)
